...
- (MDCBaseTextFieldLayout *)calculateLayoutWithTextFieldSize:(CGSize)textFieldSize {
  ...
  return [[MDCBaseTextFieldLayout alloc]
        ...
        horizontalPositioningReference:horizontalPositioningReference
                         ...
                         labelTopSpace:self.labelTopSpace
...
- (CGRect)containerFrame {
  return CGRectMake(0, 0, CGRectGetWidth(self.bounds), self.textFiledHeight);
}
...
- (CGRect)textRectForBounds:(CGRect)bounds {
  ...
  return [self adjustTextAreaFrame:CGRectMake(textRect.origin.x, self.textFiledTopPadding, textRect.size.width, self.textFiledHeight)
